...
class Results {
    bone_structure_of_the_body: string[];
    facial_bones: string[];
    flesh_of_the_body: string[];
...
export function make_questions(parent_element: HTMLElement): void {
    ...
    questions_form.addEventListener("submit", function (event: Event) {
...
function display_results(results: Results) {
    ...
    function d(text: string, clazz: string): HTMLElement {
